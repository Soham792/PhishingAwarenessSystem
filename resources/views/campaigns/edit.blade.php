                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('campaigns.update', $campaign->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="email_body" id="email_body" class="form-control" rows="8" required>{{ old('email_body', $campaign->email_body) }}</textarea>
                            @error('email_body')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="phishing_link" id="phishing_link" class="form-control" value="{{ old('phishing_link', $campaign->phishing_link) }}" required>
                            @error('phishing_link')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
